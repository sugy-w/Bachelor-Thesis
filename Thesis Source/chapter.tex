...
where $\mathbf{X}_{[t-p, t-1]} \in \mathbb{R}^{p \times t}$, $p\geq1$ is the look-back parameter and $t\geq1$, number of feature variables used, denotes  historical developments
