...
Let $N \subseteq \{i\}_{i=1}^{n}$ be the set of indices of the $k$ nearest training feature vectors to the $\bm{\hat{X}}$, in terms of $\|.\|$. Then, the approximation of the target $Y$ is 
...
that future data points of the time series are dependent on the earlier points in series. Rigorously speaking, let there be $p \in \mathbb{N}$ and
