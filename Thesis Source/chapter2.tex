...
Second, univariate $\mathbf{Y} \in \mathbb{R}^M$ accumulates values of the target variable (next closing price) to the respective rows of $\mathbf{X}$. This means, that $\mathbf{Y}[t]$ (the $t$-th value in the $Y$) is the value of the closing price on day $t$.
\par
