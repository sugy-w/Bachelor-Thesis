...
$\mathbf{X}[t]$ (the $t$-th row of $\bm{X}$) represents data available through days $t-1, t-2, \ldots, t-9$. \footnote{We chose the value of $q$ due to few reasons constant. Firstly, variable $q$ 
...
\State Retrieve the feature variables' values into the $\bm{X}$
...
% Tuto pravdepodobne nejaké vysvetleňíčko? :)
