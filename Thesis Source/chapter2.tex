...
At this point, it is sufficient to illustrate this data preparatory setup with a specific example in order to better understand Algorithm \ref{alg:sliding_window}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/VIX_example.png}
