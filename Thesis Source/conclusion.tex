...
in the particular time interval, were difficult to predict. Naïve prediction has shown great potential and justified that stock price development aligns more with the random walk \cite{fama1970efficient}. 
...
Only one framework (ARIMA model) outperformed the Naïve model in terms of dominance, which shows that time series models might be more capable of generalizing the pattern than conventional ML models.
