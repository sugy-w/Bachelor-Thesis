...
\newline
\par
Apart from the compared studies (e.g., \cite{krauss}, \cite{konferencia1}, \cite{zhao}), we researched possibilities of applying such predictions for portfolio management. The referred studies focused solely on designing the prediction pipeline and prediction evaluation. By connecting this methodology with portfolio optimization in the thesis increases the application value of the research
