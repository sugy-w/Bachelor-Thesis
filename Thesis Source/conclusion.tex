...
Chapter \ref{chap:1} introduced the fundamental concepts of ML and modeling to the reader. The chapter presents the foundations of all algorithms and frameworks used in the thesis
...
This result is often not stated in a number of studies (e.g., \cite{krauss}, \cite{konferencia1}), which might lead to an overestimation of the models' practical utility.
