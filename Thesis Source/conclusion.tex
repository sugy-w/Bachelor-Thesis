...
This result is often not stated in a number of studies, which might lead to an overestimation of the models' practical utility \cite{krauss, konferencia1}.
...
\newline
\par
Apart from the compared studies \cite{krauss,konferencia1,zhao}, possibilities of applying such predictions for portfolio management were researched. These studies focused solely on designing the prediction pipeline and prediction evaluation. Connecting this methodology with portfolio optimization increases the application value of the research.
...
false validity of the models compared to the computationally inexpensive approaches.
