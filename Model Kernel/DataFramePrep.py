...
def generate_TestDataFrame():
    ...
    # Index Data (NASDAQ and S&P 500)
    NASDAQ = pd.read_sql("SELECT * FROM Indexes WHERE IndexName='NASDAQ' AND Date>='2025-09-05'", con=StockDataDatabase, parse_dates=["Date"])
    SP500 = pd.read_sql("SELECT * FROM Indexes WHERE IndexName='S&P 500' AND Date>='2025-09-05'", con=StockDataDatabase, parse_dates=["Date"])

    # Stocks' Tickers (65 US Tech Stocks)
    tickers = pd.read_sql("SELECT * FROM Tickers", con=StockDataDatabase)

    # Market Indicators
    VIX = pd.read_sql("SELECT * FROM MarketIndicators WHERE Indicator='VIX' AND Date>='2025-09-05'", con=StockDataDatabase, parse_dates=["Date"])
    bond_13_Week = pd.read_sql("SELECT * FROM MarketIndicators WHERE Indicator='13-Week Treasury' AND Date>='2025-09-05'", con=StockDataDatabase, parse_dates=["Date"])
    bond_5_Year = pd.read_sql("SELECT * FROM MarketIndicators WHERE Indicator='5-Year Treasury' AND Date>='2025-09-05'", con=StockDataDatabase, parse_dates=["Date"])

    # Currency exchange rates
    EUR_USD = pd.read_sql("SELECT * FROM CurrencyExchange WHERE Currencies='EUR/USD' AND Date>='2025-09-05'", con=StockDataDatabase, parse_dates=["Date"])
    JPY_USD = pd.read_sql("SELECT * FROM CurrencyExchange WHERE Currencies='JPY/USD' AND Date>='2025-09-05'", con=StockDataDatabase, parse_dates=["Date"])
    GBP_USD = pd.read_sql("SELECT * FROM CurrencyExchange WHERE Currencies='GBP/USD' AND Date>='2025-09-05'", con=StockDataDatabase, parse_dates=["Date"])
    USD_CHF = pd.read_sql("SELECT * FROM CurrencyExchange WHERE Currencies='USD/CHF' AND Date>='2025-09-05'", con=StockDataDatabase, parse_dates=["Date"])
    AUD_USD = pd.read_sql("SELECT * FROM CurrencyExchange WHERE Currencies='AUD/USD' AND Date>='2025-09-05'", con=StockDataDatabase, parse_dates=["Date"])
    USD_CAD = pd.read_sql("SELECT * FROM CurrencyExchange WHERE Currencies='USD/CAD' AND Date>='2025-09-05'", con=StockDataDatabase, parse_dates=["Date"])
    NZD_USD = pd.read_sql("SELECT * FROM CurrencyExchange WHERE Currencies='NZD/USD' AND Date>='2025-09-05'", con=StockDataDatabase, parse_dates=["Date"])
